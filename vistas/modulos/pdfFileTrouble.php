...
// Pie de página
	function Footer()
	{
		...
		if($nameTE!=null){
			$this->Cell(62,8,$this->Image('firmaTE.png', 185, 185,25),1);
		}	
...
$sql = "SELECT id, problema, solucion from mttodetalle where idMttoMaestro ='".$_GET["Id"]."'";
...
$sql = "SELECT id, problema, solucion from mttodetalle where idMttoMaestro ='".$_GET["Id"]."' Limit 5";
