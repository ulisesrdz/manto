...
function Header()
{
    ...
    function Footer()
    {
        require('../../common/include.php');
    		...
    		$sql = "SELECT id, nombre, firma, fecha from mttofirmas where idMttoMaestro ='".$_POST["Id"]."' and tipoUsuario='SU' order by id desc Limit 1";
    		...
    		if($nameTE!=null){
    			$this->Cell(62,8,$this->Image('firmaTE.png', 175, 165,25),1);
    		}	
...
$sql = "SELECT id, tarea, comentario,action from mttodetalle where idMttoMaestro ='".$_POST["Id"]."' Limit 10";
